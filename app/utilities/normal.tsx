            ...
            <View style={{ marginTop: 16 }}>
              ...
              <Table>
                <TableHead>
                  ...
                  <TableCell isHeader width={80}>Z_A</TableCell>
                  <TableCell isHeader width={140}>X_i = μ + Z_A * σ</TableCell>
                </TableHead>
                {simData.map((row) => (
                  <TableRow key={row.i}>
                    <TableCell width={60}>{row.i}</TableCell>
                    <TableCell width={100}>{row.u.toFixed(4)}</TableCell>
                    <TableCell width={80}>{row.z.toFixed(4)}</TableCell>
                    <TableCell width={140}>{row.x.toFixed(4)}</TableCell>
                  </TableRow>
                ))}
              </Table>
            </View>
