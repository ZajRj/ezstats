  ...
  const tableData = useMemo(() => {
    return dfs.map(df => {
      return alphas.map(alpha => {
        ...
        return jStat.chisquare.inv(p, df).toFixed(3);
      });
    });
  }, [dfs, alphas, modeIdx]);

  const lookupChi = useMemo(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Chi-Square Table</Text>
        ...
        <View style={styles.lookupContainer}>
          ...
          <View style={styles.lookupRow}>
            ...
            <View style={styles.lookupResult}>
              ...
              <Text style={styles.lookupResultValue}>{lookupChi !== null ? lookupChi : '--'}</Text>
            </View>
          </View>
        </View>
      </View>
